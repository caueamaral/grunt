...
## package.json
Na raiz do projeto, pelo terminal digite "npm install". Ele vai se encarregar de ler as dependências do projeto e criar uma pasta chamada "node_modules". Essa
